              ...
              children: [
                ...
                Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          /* Informação com o número de jogadores participantes em uma partida */
                          Text("2",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 18.0,
                ...
                /* Informações descrevendo o objetivo do jogo */
                Row(children: [
                  Image.asset(
                ...
                /* Informações contendo os valores de cada carta do jogo */
                Align(
                    alignment: Alignment.centerLeft,
                    child: Padding(
                        padding: EdgeInsets.only(left: 10.0, top: 20.0),
                    ...
                    child: Column(children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                              child: Text(
                                  "O Ás vale 1 ou 11 pontos de acordo com a vontade do jogador, que deverá decidir o valor da carta.",
                                  style: TextStyle(
                                      color: Colors.white, fontSize: 18.0))),
                        ],
                      ),
                    ])),
                /* Informações explicando as regras do jogo */
                Padding(
                    padding: EdgeInsets.only(top: 20.0),
                    child: Row(children: [
                      Image.asset(
